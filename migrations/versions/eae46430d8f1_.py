...
Revision ID: eae46430d8f1
Revises: a5cffa318ac2
Create Date: 2026-01-30 18:17:14.406885
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('media_type', sa.Enum('photo', 'video', 'gif', name='media_type_enum'), nullable=False),
